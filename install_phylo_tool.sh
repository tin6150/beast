...
apt-get -y --quiet install beast2-mcmc beast2-mcmc-examples beast2-mcmc-doc mrbayes mrbayes-doc mrbayes-mpi raxml  mafft muscle libmuscle1 libmuscle-dev tree-puzzle tree-puzzle-doc sumtrees seaview phyx phyutility physamp phyml phast paml  njplot  metaphlan2 metaphlan2-data clearcut examl fastdnaml clustalw clustalo
echo $?
apt-get -y --quiet install figtree bali-phy treeviewx  belvu bppphyview clustalx
echo $?
